...
let simulateButton = document.getElementById("play");
...
const player1 = new Player("Bishway", 100, 10)
const player2 = new Player("Sumon", 100, 10)
...
// *** Adding Event Listener in Attack Button for player1 ***
...
// *** Adding Event Listener in Heal Button for player1 ***
document.addEventListener("keydown", (event) => {
    // if you press Q AND the enemy health is greater than 0 AND isOver is still false then strike()
    if (event.key === "a" && 0 <= p1.health <= 100 && game.isOver == false) {
        p1.heal(p1)
        document.getElementById("p1Heal").play()
    }
})

// *** Adding Event Listener in Attack Button for player2 ***
document.addEventListener("keydown", (event) => {
